...
export class FileService {
  ...
  public uploadBase64Image = async (folder: string, base64: string) => {
    ...
    try {
      ...
      const response = await axios.post(
        this.fileBaseUrl + '/api/file/upload-base64',
        body,
        {
          headers: {
  ...
  public uploadMultiFiles = async (
    ...
    try {
      ...
      const response = await axios.post(
        this.fileBaseUrl + '/api/file/upload-multiple',
        formData,
        {
          headers: {
            ...formData.getHeaders(),
  ...
  public uploadPdfToImage = async (
    ...
    try {
      ...
      formData.append('file', file.buffer, file.originalname);
      const response = await axios.post(
        this.fileBaseUrl + '/api/file/pdf-to-image',
        formData,
        {
          headers: {
            ...formData.getHeaders(),
